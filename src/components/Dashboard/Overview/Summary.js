        ...
        <div>
          <form >
            <div className="i-power-form-rol">
              ...
              <div style={{color:'grey', marginTop:"20px"}} className="rand-header-2">Please choose the preferred payment option</div>
                
                <div className="confirm-button-2-row">
                    <div className="confirm-button-2-col">
                        <div className="confirm-button-2">
                            <div> <img src={card} alt="" className="confirm-button-2-image"/></div>
                            <div>Card</div>
                        </div>
                    </div>
                    <div className="confirm-button-2-col">
                        <div className="confirm-button-2">
                            <div> <img src={ussd} alt="" className="confirm-button-2-image"/></div>
                            <div>Ussd</div>
                        </div>
                    </div>
                    <div className="confirm-button-2-col">
                        <div className="confirm-button-2">
                            <div> <img src={bank} alt="" className="confirm-button-2-image"/></div>
                            <div>Bank</div>
                        </div>
                    </div>
                    <div className="confirm-button-2-col">
