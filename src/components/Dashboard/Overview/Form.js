        ...
        <div>
          <form>
            <div className="i-power-form-rol">
              <div className="i-power-form-col">
                <div className="form-col-label">
                  What is your{" "}
                  <span className="form-col-spotlight">Meter Number</span> ?{" "}
            ...
            <div className="i-power-form-rol">
              <div className="i-power-form-col">
                <div className="form-col-label">
                  ...
                  <span className="form-col-spotlight">Phone Number</span> ?{" "}
                  <span className="form-col-required">*</span>
                </div>
                <input
                  type="text"
            ...
            <div className="i-power-form-rol">
              <div className="i-power-form-col">
                <div className="form-col-label">
                  <span className="form-col-spotlight">Amount</span> you are
                  willing to charge<span className="form-col-required">*</span>
                </div>
                <input
                  type="text"
                  className="i-power-form-textfield w-input"
            ...
            <div className="i-power-form-rol">
              <div className="i-power-form-col i-btn">
                <div onClick={props.switchToSummary} className="i-power-button">
                  Buy Unit
                </div>
