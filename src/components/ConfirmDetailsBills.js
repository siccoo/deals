...
const ConfrimDetailsBills = (props) => {
  return (
    <>
      ...
      <div style={{ color: "grey", marginTop: "20px" }} className="rand-header">
      ...
      <div className="confirm-button-row">
        <div className="confirm-button-col">
          <div className="confirm-button">
            <div>
              {" "}
              <img src={card} alt="" className="confirm-button-image" />
            </div>
            <div>Card</div>
          </div>
        </div>
        <div className="confirm-button-col">
          <div className="confirm-button">
            <div>
              {" "}
              <img src={ussd} alt="" className="confirm-button-image" />
            </div>
            <div>Ussd</div>
          </div>
        </div>
        <div className="confirm-button-col">
          <div className="confirm-button">
            <div>
              {" "}
              <img src={bank} alt="" className="confirm-button-image" />
            </div>
            <div>Bank</div>
          </div>
        </div>
